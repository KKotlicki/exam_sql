...
ALTER TABLE ZbiornikWodny ADD COLUMN geom geometry(LINESTRING, 2180);
...
-- Zadanie 3
-- Napisz w języku SQL zapytanie, które wyświetli nazwy zbiorników znajdujących się na terenie największego Zarządu Gospodarki Wodnej. Skorzystaj z funkcji przestrzennej.
